...
def excel_read():
    ...
    emi_source = pd.read_csv('data/emission_AM1.5.csv')
    ...
    # read reflectivity of nanostructure from forward direction and backward direction
    rho_forward = pd.read_excel("data/rho_forward.xlsx", index_col=0)
    rho_backward = pd.read_excel("data/rho_backward.xlsx", index_col=0)
    
    return abs_matrix, EQE_pv, IQE_pv, emi_source, abs_particle, emi_particle, rho_forward, rho_backward
